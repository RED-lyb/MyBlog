...
<template>
  <div class="footer">
    ...
    <div class="icons">
      <a :href="config?.github_link || '#'"><svg xmlns="http://www.w3.org/2000/svg" 
      ...
      <a :href="config?.gitee_link || '#'"><svg xmlns="http://www.w3.org/2000/svg" 
        width="2em" height="2em"
          viewBox="0 0 24 24">
          <path fill="currentColor"
      ...
      <a :href="config?.bilibili_link || '#'"><svg xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="copyright">
      <p>{{ config?.blog_name || '' }} | {{ config?.author || '' }}</p>
    </div>
  </div>
</template>
<style scoped>
