...
class LoveNestConfig(models.Model):
    """爱情小窝全局配置表"""
    id = models.PositiveIntegerField(primary_key=True, db_comment='主键，固定为 1')
...
class LoveNestTravelCity(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'love_nest_travel_cities'
...
class LoveNestPhoto(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'love_nest_photos'


class LoveNestDiary(models.Model):
    """爱情小窝时光表"""
    id = models.AutoField(primary_key=True, db_comment='主键，自增')
    ...
    class Meta:
        managed = False
        db_table = 'love_nest_diaries'


class LoveNestMilestone(models.Model):
    """爱情小窝纪念日表"""
    id = models.AutoField(primary_key=True, db_comment='主键，自增')
    title = models.CharField(max_length=200, db_comment='纪念日名称')
