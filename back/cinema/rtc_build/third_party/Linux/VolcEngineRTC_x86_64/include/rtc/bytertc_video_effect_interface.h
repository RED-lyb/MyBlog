...
public:
     ...
     * @type api
     * @brief 设置视频特效素材包。
     * @param [in] effect_node_paths 特效素材包绝对路径数组。
     *        要取消当前视频特效，将此参数设置为 null。
     * @param [in] node_num 特效素材包个数。
     * @return  <br>
     *      + 0: 调用成功。
     *      + –1000: 未集成特效 SDK。
     *      + –1001: 特效 SDK 不支持该功能。
     ...
     * @param [in] effect_node_paths Array of effect material package paths. <br>
     *        To remove the current video effect, set it to null.
     * @param [in] node_num Number of effect material packages.
     * @return   <br>
     *      + 0: Success.
     *      + –1000: The Effects SDK is not integrated.
     *      + –1001: This API is unavailable for your Effects SDK.
     ...
     * @param [in] effect_node_paths Array of effect material package paths.
     * @param [in] node_num Number of effect material packages.
     * @return  <br>
     *      + 0: Success.
     *      + –1000: The Effects SDK is not integrated.
     ...
     * @type api
     * @brief 设置特效强度。
     * @param [in] effect_node_path 特效素材包绝对路径，参考[素材包结构说明](https://www.volcengine.com/docs/6705/102039)。
     * @param [in] node_key 需要设置的素材 key 名称，参考[素材 key 对应说明](https://www.volcengine.com/docs/6705/102041)。
     * @param [in] node_value 特效强度值，取值范围 [0,1]，超出范围时设置无效。
     * @return  <br>
     *      + 0: 调用成功。
     *      + –1000: 未集成特效 SDK。
     *      + –1001: 特效 SDK 不支持该功能。
     ...
     * @param [in] effect_node_path The absolute path of the effects resource package, see [Resource Package Structure](https://docs.byteplus.com/effects/docs/resource-package-structure-v421-and-later).
     * @param [in] node_key The name of the material key to be set, see [Functions of Resource Keys](https://docs.byteplus.com/effects/docs/functions-of-resource-keys-v421-and-later) for the value.
     * @param [in] node_value The intensity value that needs to be set, the value range [0,1], and the setting is invalid when it exceeds the range.
     * @return   <br>
     *      + 0: Success.
     *      + –1000: The Effects SDK is not integrated.
     *      + –1001: This API is unavailable for your Effects SDK.
     ...
     * @param [in] res_path Filter effects package absolute path.
     * @return   <br>
     *      + 0: Success.
     *      + –1000: The Effects SDK is not integrated.
     *      + –1001: This API is unavailable for your Effects SDK.
     ...
     * @param [in] sticker_path 特效素材包绝对路径。
     *        要取消当前视频特效，将此参数设置为 null。
     * @return  <br>
     *      + 0: 调用成功。
     *      + –1000: 未集成特效 SDK。
     ...
     * @param [in] sticker_path effect material package path. <br>
     *        To remove the current video effect, set it to null.
     * @return   <br>
     *      + 0: Success.
     *      + –1000: The Effects SDK is not integrated.
     ...
     * @param [in] background_sticker_path 背景贴纸特效素材绝对路径。
     ...
     * @param [in] background_sticker_path The absolute path of virtual background effects.
     ...
     * @type api
     * @brief 开启人像属性检测。
     * @param [in] expression_detection_config 人像属性检测参数，参看 VideoEffectExpressionConfig{@link #VideoEffectExpressionConfig}。
     * @return  <br>
     *      + 0: 调用成功。
     *      + –1000: 未集成特效 SDK。
     *      + –1001: 特效 SDK 不支持该功能。
     ...
     * @param [in] expression_detection_config Expression detection configuration. See VideoEffectExpressionConfig{@link #VideoEffectExpressionConfig}.
     * @return  <br>
     *      + 0: Success.
     *      + –1000: The Effects SDK is not integrated.
     *      + –1001: This API is unavailable for your Effects SDK.
     ...
     * @param [in] face_model_path 人脸检测算法模型文件路径，一般为 ttfacemodel 文件夹中 tt_face_vXXX.model 文件的绝对路径。
     * @return  <br>
     *      + 0: 调用成功。
     *      + –1000: 未集成特效 SDK。
     *      + –1001: 特效 SDK 不支持该功能。
     ...
     * @param [in] face_model_path The absolute path of the face detection algorithm file. Typically it is the tt_face_vXXX.model file in the ttfacemodel folder.
     * @return <br>
     *      + 0: Success.
     *      + –1000: The Effects SDK is not integrated.
     *      + –1001: This API is unavailable for your Effects SDK.
     ...
     * @param [in] model_path 传入背景贴纸特效素材路径。  <br>
     ...
     * @param [in] model_path Set the path of virtual background effects.  <br>
