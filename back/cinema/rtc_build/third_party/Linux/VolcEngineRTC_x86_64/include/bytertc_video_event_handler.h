...
public:
    ...
    */
     ...
     * @param  [in] key Remote stream information. See RemoteStreamKey {@link #RemoteStreamKey}.
     * @param  [in] error Render error. See RenderError {@link #RenderError}.
     * @param  [in] message Error message
     * @notes This callback is currently only used internally, which developers need not pay attention to.
     */
